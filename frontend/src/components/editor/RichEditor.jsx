  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflow: 'auto' }}>
        <style>{`
          .rich-editor-content { outline: none; padding: 20px 32px 64px; min-height: 100%; font-family: var(--font-sans); font-size: 15px; line-height: 1.8; color: var(--text-primary); }
          ...
          .rich-editor-content p { margin: 0.3em 0; }
          .rich-editor-content p.is-editor-empty:first-child::before { content: attr(data-placeholder); color: var(--text-muted); float: left; height: 0; pointer-events: none; }
          ...
          .rich-editor-content ul[data-type="taskList"] li input { margin-top: 4px; accent-color: var(--accent); cursor: pointer; width: 15px; height: 15px; }
          .rich-editor-content ul[data-type="taskList"] li[data-checked="true"] > div { text-decoration: line-through; color: var(--text-muted); }
          .rich-editor-content blockquote { border-left: 3px solid var(--accent); padding-left: 1em; color: var(--text-secondary); margin: 0.8em 0; font-style: italic; }
          ...
          .hljs-keyword { color: #ff79c6; } .hljs-string { color: #f1fa8c; } .hljs-comment { color: #6272a4; } .hljs-number { color: #bd93f9; } .hljs-built_in { color: #8be9fd; } .hljs-function { color: #50fa7b; }
        `}</style>
